...
public class ProductCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("pruchaseDate"))) {
			request.setAttribute("pruchaseDate", PropertyReader.getValue("error.require", "pruchaseDate"));
			pass = false;
		}else if (!DataValidator.isDate(request.getParameter("pruchaseDate"))) {
			request.setAttribute("pruchaseDate", PropertyReader.getValue("error.date", "purchase Date"));
			pass = false;
		}
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		bean.setProductName(DataUtility.getString(request.getParameter("customerName")));
		...
		bean.setPruchaseDate(DataUtility.getDate(request.getParameter("pruchaseDate")));
